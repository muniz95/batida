...
class FakeAppointmentRepository implements AppointmentRepository {
  FakeAppointmentRepository({List<WorkAppointment>? initialAppointments})
    : _appointments = List<WorkAppointment>.from(
        initialAppointments ?? const <WorkAppointment>[],
      );

  final List<WorkAppointment> _appointments;

  List<WorkAppointment> get storedAppointments =>
      List<WorkAppointment>.unmodifiable(_appointments);
